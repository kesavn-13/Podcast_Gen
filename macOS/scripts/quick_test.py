...
async def quick_test():
    ...
    try:
        ...
        print("   Run: pip install google-generativeai TTS pydub")
        return False
    ...
    # Test 4: TTS capabilities (Coqui)
    print("\n🎤 Testing TTS capabilities (Coqui)...")
    try:
        from app.audio_generator import CoquiLocalTTSEngine, AudioSegment
        engine = CoquiLocalTTSEngine()
        seg = AudioSegment(text="Hello, this is a Coqui TTS test.", speaker="narrator")
        import asyncio as _asyncio
        _asyncio.get_event_loop()
        print("✅ Coqui Local TTS ready")
    except Exception as e:
